...
import { ApplicationInterfaceDetailPage } from './ApplicationInterfaceDetailPage';
...
vi.mock('react-router-dom', async () => {
  ...
  return {
    ...actual,
    useNavigate: () => vi.fn(),
    useParams: () => ({ id: 'interface-001' }),
  };
});

describe('ApplicationInterfaceDetailPage', () => {
  ...
  beforeEach(() => {
    ...
    mockUseEntityDetail.mockReturnValue({
      entity: { id: 'interface-001', name: 'REST API v2' },
      loading: false,
      error: null,
      isNotFound: false,
      isForbidden: false,
  ...
  it('renders detail page title', () => {
    ...
    expect(screen.getByText('Application Interface Details')).toBeInTheDocument();
  });

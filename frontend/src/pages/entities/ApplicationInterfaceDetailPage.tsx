...
export const ApplicationInterfaceDetailPage: React.FC = () => {
  ...
  if (!id) {
    return <div>Invalid application interface ID</div>;
  }
  ...
  const properties: Property[] = entity
    ? [
        ...
        { key: 'sourceApplicationId', label: 'Source Application', value: entity.sourceApplicationId },
        { key: 'targetApplicationId', label: 'Target Application', value: entity.targetApplicationId },
  ...
  const tabs = [
    {
      ...
      content: (
        <div>
          <h3 style={{ marginTop: 0 }}>Application Interface Details</h3>
  ...
  return (
    <EntityDetailTemplate
      ...
      title={entity?.name || 'Application Interface'}

...
export const ServerDetailPage: React.FC = () => {
  ...
  const properties: Property[] = entity
    ? [
        ...
        { key: 'hostname', label: 'Hostname', value: entity.hostname },
        { key: 'ipAddress', label: 'IP Address', value: entity.ipAddress },
        { key: 'environment', label: 'Environment', value: entity.environment?.toUpperCase() },
  ...
  const tabs = [
    {
      ...
      content: (
        <div>
          <h3 style={{ marginTop: 0 }}>Server Details</h3>

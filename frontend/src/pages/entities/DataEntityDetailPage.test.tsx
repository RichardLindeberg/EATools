...
import { DataEntityDetailPage } from './DataEntityDetailPage';
...
describe('DataEntityDetailPage', () => {
  ...
  beforeEach(() => {
    ...
    mockUseEntityDetail.mockReturnValue({
      entity: { id: 'entity-001', name: 'Customer Record' },
      loading: false,
      error: null,
      isNotFound: false,
      isForbidden: false,
  ...
  it('renders detail page title', () => {
    ...
    expect(screen.getByText('Data Entity Details')).toBeInTheDocument();
  });

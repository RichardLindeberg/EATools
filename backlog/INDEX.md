...
### Creating New Items
Use [TEMPLATE.md](TEMPLATE.md) when creating new backlog items. The template includes:
- Standard sections for consistency
- File management instructions
- Examples and guidance
- Process for moving completed items to old/
...
- [BACKLOG.md](../BACKLOG.md) - Main backlog overview
- [docs/](../docs/) - User documentation
- [spec/](../spec/) - Formal specifications
- [CHANGELOG.md](../CHANGELOG.md) - (if exists) Release notes
